...
| `duration` | 45초 | 60초로 시작했다가 첫 플레이 후 내렸다. 원칙 5(30초~2분)의 아래쪽 |
...
- 시간제 + 콤보 초기화 모델에서도 "한 판 더"가 생기는가? (`duration` 은 60 → 45 로 내린 상태.)
